...
from utils.config import PROPERTY_FULL_NAMES, PROPERTY_IMPV_THRESHOLDS, DEFAULT_PROPERTY_TEST_THRESHOLDS_UPPER
...
class Prompter:
    ...
    def __init__(self, opt_type: str = 'thresh', 
        ...
        with open(f"{template_dir}/{opt_type}.json", "r") as f:
